# 山东大学程序思维设计与实践作业-Week1
**仅作参考，切莫照搬，有查重**
## 代码题目
- 直接前往[Github](https://github.com/W1412X/cxsj_sduoj)点击获取
- 通过
```shell
 git clone https://github.com/W1412X/cxsj_sduoj
```
克隆项目到本地
- 访问 https://github.com/W1412X/cxsj_sduoj 获取
## 简答题
## 1
$$
f_4(n)=n^8+n!\\
